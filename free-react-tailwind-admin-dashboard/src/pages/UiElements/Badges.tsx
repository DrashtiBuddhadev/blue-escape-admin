...
export default function Badges() {
  return (
    <div>
      <PageMeta
        title="React.js Badges Dashboard | Blue Escape - React.js Admin Dashboard Template"
        description="This is React.js Badges Dashboard page for BlueEscape - React.js Tailwind CSS Admin Dashboard Template"
      />
