...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | BlueEscape - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for BlueEscape - React.js Tailwind CSS Admin Dashboard Template"
      />
